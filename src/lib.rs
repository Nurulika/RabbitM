// src/lib.rs
/*
 * Core library for RabbitMQQueue
 */
...
#[derive(Debug)]
pub struct RabbitMQQueueProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RabbitMQQueueProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RabbitMQQueue processing");
    
    let mut processor = RabbitMQQueueProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RabbitMQQueueProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RabbitMQQueueProcessor::new(false);
